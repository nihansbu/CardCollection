...
- Die `ContentPanel`-Header-Bar ist mobil standardmaessig eingeklappt, damit Body und InfoPanel mehr nutzbare Flaeche bekommen. Oben mittig sitzt ein generierter goldener Knauf/Pfeil (`public/ui/header-toggle-knob.png`), der die Header-Bar ein- und ausfaehrt. Ausgeklappt rotiert der Knauf nach oben und sitzt unterhalb der Header-Bar.
